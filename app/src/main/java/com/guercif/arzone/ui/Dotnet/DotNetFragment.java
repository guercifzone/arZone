...
public class DotNetFragment extends Fragment {
    private DotNetViewModel csharpViewModel;
    ListView lvRss;
    ArrayList<String> titles;
    ArrayList<String>link;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        csharpViewModel = new ViewModelProvider(this).get(DotNetViewModel.class);
        View root =  inflater.inflate(R.layout.fragment_dotnet, container, false);
        ...
        new DotNetFragment.ProcessInBackground().execute();
        return root;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/dotnet?alt=rss");
