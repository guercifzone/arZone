...
public class GtkFragment extends Fragment {
    private GtkViewModel gtkViewModel;
    ListView lvRss;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        gtkViewModel = new ViewModelProvider(this).get(GtkViewModel.class);
        View root = inflater.inflate(R.layout.fragment_gtk,container,false);
        ...
        new GtkFragment.ProcessInBackground().execute();
        return root;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/GTK?alt=rss");
