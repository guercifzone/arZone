...
public class Blogger_Fragment extends Fragment {
private  BloggerViewModel bloggerViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       bloggerViewModel = new ViewModelProvider(this).get(BloggerViewModel.class);
        View root = inflater.inflate(R.layout.fragment_blogger,container,false);
        ...
        new Blogger_Fragment.ProcessInBackground().execute();
        return root;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/Blogger?alt=rss");
