...
public class AlgorithmesFragment extends Fragment {
    private AlgorithmesViewModel algorithmesViewModel;
   ListView lvRss;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        algorithmesViewModel = new ViewModelProvider(this).get(AlgorithmesViewModel.class);
        View root = inflater.inflate(R.layout.fragment_algorithmes,container,false);
     lvRss = root.findViewById(R.id.listview);
      ...
      new AlgorithmesFragment.ProcessInBackground().execute();
        return root;
       }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/Algorithmes?alt=rss");
