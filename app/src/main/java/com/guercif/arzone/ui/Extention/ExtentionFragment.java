...
public class ExtentionFragment extends Fragment {
    private ExtentionViewModel extentionViewModel;
    ListView lvRss;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        extentionViewModel = new ViewModelProvider(this).get(ExtentionViewModel.class);
        View root = inflater.inflate(R.layout.fragment_extention,container,false);
        ...
        new ExtentionFragment.ProcessInBackground().execute();
        return root;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/extention?alt=rss");
