...
import com.guercif.arzone.ui.Home.HomeFragment;
import com.guercif.arzone.ui.Home.HomeViewModel;
...
public class TutarielFragment extends Fragment {
    private TutarielViewModel tutarielViewModel;
    ListView lvRss;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        tutarielViewModel = new ViewModelProvider(this).get(TutarielViewModel.class);
        View root = inflater.inflate(R.layout.fragment_tutariel,container,false);
        ...
        new TutarielFragment.ProcessInBackground().execute();
        return root;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Void,Exception> {
        ...
        protected Exception doInBackground(Integer... integers) {
            try {
                URL url = new URL("https://guercifzone-ar.blogspot.com/feeds/posts/default/-/tutarial?alt=rss");
